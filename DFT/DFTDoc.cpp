...
void CDFTDoc::StartComputing(const Options& options)
{
	...
	std::thread([this, options]() {
		...
		//DFT::DftSolverCompressed<DFT::ChachiyoExchCor<DFT::ChachiyoExchCorImprovedParam>> dftSolver(options.dim1, options.dim2, options.dim3, options.samples1, options.samples2, options.samples3, options.Ns);
